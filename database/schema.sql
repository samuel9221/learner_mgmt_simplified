...
CREATE TABLE subjects (
    ...
    applicable_levels VARCHAR(50)[] DEFAULT ARRAY['S1','S2','S3','S4','S5','S6'],
    created_by UUID NOT NULL REFERENCES users(id),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
-- =============================================================================
-- ADDITIONAL TABLES FOR SUBJECTS, TEACHERS, CLASS & STREAM HANDLING
-- =============================================================================
...
CREATE TABLE subject_combinations (
    ...
    combination_code VARCHAR(20) UNIQUE NOT NULL,
    description TEXT,
...
-- 1. Exam Sessions (Mid Term / End of Term per term)
...
-- 2. Exam Results (individual scores per learner per subject)
CREATE TABLE exam_results (
    ...
    CONSTRAINT exam_results_unique_paper UNIQUE (learner_id, subject_id, exam_session_id, paper_number)
);
...
-- 3. Final Results (computed after exam sessions are closed)
